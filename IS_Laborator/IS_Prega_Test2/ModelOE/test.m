...
yid1 = id.y; yval = val.y;
uid1 = id.u; uval = val.u;
ts = 0.01;
nk = 2;
...
while(L_minim<N)
    ...
    e(1:nk)=uid1(1:nk);
    for i = nk+1:N
        e(i) = yid1(i) + theta0(1)*yid1(i-1)- theta0(2)*uid1(i-nk)-theta0(1)*e(i-1);
        de_f(i) =yid1(i-1)-e(i-1)-theta0(1)*de_f(i-1);
        de_b(i) = -uid1(i-nk)-theta0(1)*de_b(i-1);
    end
...
compare(modelOE,val,200);

%%
uz = zeros(10,1);
uz = uz(:);
N = 200;
u_spab = (N; 'prbs', [], [-0.7 0,7]);
u_step = o.4*ones(70,1);
u = [uz;u_spab;u_step];
[vel,alpha,t] = r
